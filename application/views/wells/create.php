                            ...
                            <div class="card-body row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input required name="name1" class="form-control name-1" type="text" maxlength="6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input required name="tubing_size" class="form-control" type="text" placeholder="Enter tubing size">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="col-form-label pt-0">Max Angle</label>
                                    <input required name="max_angle" class="form-control" type="text" placeholder="Enter tubing size">
                                </div>
                                <div class="mb-3 col-md-6">
