                    ...
                    <form action="<?= base_url("wells/update/" . encode($well['id'])) ?>" method="POST" enctype="multipart/form-data">
                        <div class="card">
                            ...
                            <div class="card-body row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input disabled value="<?= $well['names'][0] ?>" name="name1" class="form-control name-1" type="text" maxlength="6">
                                        <span class="input-group-text">-</span>
                                        <input disabled value="<?= $well['names'][1] ?>" name="name2" class="form-control name-2" type="text">
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="col-form-label pt-0">Field</label>
                                    <select disabled name="field_id" class="form-select digits">
                                        <?php
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input disabled value="<?= $well['tubing_size'] ?>" name="tubing_size" class="form-control" type="text" placeholder="Enter tubing size">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="col-form-label pt-0">Max Angle</label>
                                    <input disabled value="<?= $well['max_angle'] ?>" name="max_angle" class="form-control" type="text" placeholder="Enter tubing size">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="col-form-label pt-0">Type</label>
                                    <select disabled name="type" class="form-select digits">
                                        <option <?php
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input disabled name="schematic" class="form-control" type="file">
                                    <?php
                            ...
                            <div class="card-footer text-end">
                                <a href="<?= base_url("wells") ?>"><button type="button" class="btn btn-secondary">Back</button></a>
                            </div>
                        </div>
                    </form>
                </div>
