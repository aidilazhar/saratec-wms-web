                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action d-flex justify-content-around w-50 text-center mx-auto">
                                                ...
                                                <li class="edit"> <a href="<?= base_url('packages/edit/' . encode($package['id'])) ?>"><i class="icon-pencil-alt"></i></a></li>
                                                <li class="delete"><a href="<?= base_url('packages/delete/' . encode($package['id'])) ?>"><i class="icon-trash"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                <?php
