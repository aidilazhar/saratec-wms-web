                            ...
                            <div class="col-md-2 mx-auto mb-2">
                                ...
                                <ul class="dropdown-menu" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 40px);" data-popper-placement="bottom-start">
                                    <li><a class="dropdown-item <?php if ($prefix == 'mhsi_') {
                                                                    echo 'active';
                                                                } ?>" href="<?= base_url($wire_name . '/third-party-data/mhsi_' . '?smart_monitor=' . encode($smart_monitor_id)) ?>">MHSI</a></li>
                                    <li><a class="dropdown-item <?php if ($prefix == 'mhi_') {
                                                                    echo 'active';
                                                                } ?>" href="<?= base_url($wire_name . '/third-party-data/mhi_' . '?smart_monitor=' . encode($smart_monitor_id)) ?>">MHI</a></li>
                                </ul>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action d-flex justify-content-around w-50 text-center mx-auto">
                                                    <li class="view"><a href="<?= base_url($wire_name . '/third-party-data/') . '/mhsi_' ?>?smart_monitor=<?= encode($smart_monitor['id']) ?>"><i class="icon-bar-chart"></i></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                    <?php
