<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12 col-xl-12">
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?= base_url('companies/' . encode($company_id) . '/clients/store') ?>" method="POST">
                        <div class="card">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input required name="representative" class="form-control" type="text" placeholder="Enter representative">
                                </div>
                            </div>
